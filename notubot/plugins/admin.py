...
CMD_HELP.update(
    {
        "admin": [
            "Admin",
            f">`{HANDLER}promote <id/username/reply> <title (optional)>`\n"
            "↳ : Promote user menjadi admin.\n\n"
            f">`{HANDLER}demote <id/username/reply>`\n"
            "↳ : Demote seorang admin.\n\n"
            f">`{HANDLER}fpromote|fullpromote <id/username/reply> <title (optional)>`\n"
            "↳ : Promote user menjadi cofounder.\n\n"
            f">`{HANDLER}kick <id/username/reply> <reason (optional)>`\n"
            "↳ : Kick user dari grup.\n\n"
            f">`{HANDLER}ban <id/username/reply> <reason (optional)>`\n"
            "↳ : Banned user dari grup.\n\n"
            f">`{HANDLER}unban <id/username/reply>`\n"
            "↳ : Unbanned user dari grup.\n\n"
            f">`{HANDLER}mute <id/username/reply> <reason (optional)>`\n"
            "↳ : Mute user dari grup.\n\n"
            f">`{HANDLER}unmute <id/username/reply>`\n"
