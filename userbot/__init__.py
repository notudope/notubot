...
UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL", "https://github.com/notudope/notubot.git")
...
async def check_alive():
    await bot.send_message(BOTLOG_CHATID, f"`⚡NOTUBOT UserBot⚡ v{BOT_VER} Launched 🚀`")
