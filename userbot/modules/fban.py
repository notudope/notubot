...
async def fban(event):
    ...
    if event.sender_id == fban_id:
        return await event.edit("**Error: This action has been prevented by KensurBot self preservation protocols.**")
    ...
    for i in fed_list:
        ...
        try:
            async with bot.conversation(chat) as conv:
                ...
                await bot.send_read_acknowledge(conv.chat_id, message=reply, clear_mentions=True)
...
async def addf(event):
    ...
    try:
        ...
        return await event.edit("**This group is already connected to federations list.**")
