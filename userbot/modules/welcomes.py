...
async def welcome_to_chat(event):
    try:
        from userbot.modules.sql_helper.welcome_sql import get_current_welcome_settings, update_previous_welcome
...
async def save_welcome(event):
    ...
    if msg and msg.media and not string:
        if BOTLOG_CHATID:
            ...
            return await event.edit("`Saving media as part of the welcome note requires the BOTLOG_CHATID to be set.`")
