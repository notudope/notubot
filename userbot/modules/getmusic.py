...
async def _(event):
    ...
    try:
        ...
        return await event.edit("`Error: `@SpotifyMusicDownloaderBot` is not responding or Song not found!.`")
...
async def _(event):
    ...
    try:
        ...
        return await event.edit("`Error: `@WooMaiBot` is not responding or Song not found!.`")
...
async def _(event):
    ...
    try:
        ...
        return await event.edit("`Error: `@MusicsHunterBot` is not responding or Song not found!.`")


@register(outgoing=True, pattern=r"^\.deez (now|.+)( FLAC| MP3\_320| MP3\_256| MP3\_128)?")
async def _(event):
