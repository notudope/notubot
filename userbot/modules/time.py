...
async def time_func(tdata):
    ...
    if c_name != COUNTRY:
        return await tdata.edit(f"`It's`  **{dtnow}**  `in {c_name}({time_zone} timezone).`")
    elif COUNTRY:
        return await tdata.edit(f"`It's`  **{dtnow}**  `here, in {COUNTRY}" f"({time_zone} timezone).`")
...
async def date_func(dat):
    ...
    if c_name != COUNTRY:
        return await dat.edit(f"`It's`  **{dtnow}**  `in {c_name}({time_zone} timezone).`")
    elif COUNTRY:
        return await dat.edit(f"`It's`  **{dtnow}**  `here, in {COUNTRY}" f"({time_zone} timezone).`")
