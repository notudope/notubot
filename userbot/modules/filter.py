...
async def add_new_filter(new_handler):
    ...
    if msg and msg.media and not string:
        if BOTLOG_CHATID:
            ...
            return await new_handler.edit("`Saving media as reply to the filter requires the BOTLOG_CHATID to be set.`")
...
async def kick_marie_filter(event):
    ...
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "I cleaned all filters at " + str(event.chat_id))
